...
for tensor in original_graph.as_graph_def().node:
  ...
  print(tensor_name, '\n')
    ...
    #print(tensor_name, '\n')
  if tensor_name == "MultipleGridAnchorGenerator/Identity":
    #print(tensor_name, '\n')
    print(tensor)
...
def get_anchors(graph, tensor_name):
    ...
    print('box_corners.shape: ', box_corners.shape)# (1, 1917, 4)
...
anchors_tensor = "MultipleGridAnchorGenerator/Identity:0"
