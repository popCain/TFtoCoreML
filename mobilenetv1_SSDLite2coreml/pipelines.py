...
ssd_path = 'mobilenetV1_SSD.mlmodel'
...
pipeline.spec.description.metadata.versionString = "MobileNetV1_SSDLite"
pipeline.spec.description.metadata.shortDescription = "MobileNetV1 + SSDLite(tensorflow), trained on COCO"
...
final_coreml_model_path = 'MobileNetV1_SSDLite.mlmodel'
