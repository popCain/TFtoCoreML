...
pipeline.spec.description.metadata.versionString = "MobileNetV3_SSDLite_small"
pipeline.spec.description.metadata.shortDescription = "MobileNetV3 + SSDLite(tensorflow), trained on COCO"
...
final_coreml_model_path = 'MobileNetV3_SSDLite_small.mlmodel'
