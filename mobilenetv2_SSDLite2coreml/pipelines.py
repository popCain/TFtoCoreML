...
ssd_path = 'ssd_mobilenet.mlmodel'
...
ssd_output[1].type.multiArrayType.shape[:] = [num_classes + 1, num_anchors, 1]
ssd_output[0].type.multiArrayType.shape[:] = [4, num_anchors, 1]
...
pipeline.spec.description.metadata.versionString = "MobileNetV2_SSDLite"
pipeline.spec.description.metadata.shortDescription = "MobileNetV2 + SSDLite(tensorflow), trained on COCO"
...
final_coreml_model_path = 'MobileNetV2_SSDLite.mlmodel'
