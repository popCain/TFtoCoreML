...
spec.description.output[1].name = "scores"
spec.description.output[1].shortDescription = "Predicted class scores for each bounding box"
spec.description.output[0].name = "boxes"
...
spec.description.output[1].type.multiArrayType.shape.append(num_classes + 1)
...
del spec.description.output[0].type.multiArrayType.shape[-1]
